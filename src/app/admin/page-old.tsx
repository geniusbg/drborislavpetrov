...
import { Calendar, Users, Clock, TrendingUp, ArrowLeft, Smartphone, LogOut, Plus, Edit, Trash2, BarChart3, Mic, X, Bug, FileText, MessageSquare, ChevronUp, ChevronDown, Settings, CheckCircle } from 'lucide-react'
...
export default function AdminPage() {
  ...
  return (
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      {/* Modern Header */}
      <header className={`fixed top-0 left-0 right-0 z-40 bg-gradient-to-r from-blue-600 to-blue-800 shadow transition-transform duration-100 ${
      ...
      {/* Sticky Navigation */}
      <div className={`sticky top-0 z-30 bg-white border-b border-gray-200 transition-all duration-100 ${
        isHeaderVisible ? 'mt-0' : 'mt-0'
      }`}>
        <div className="max-w-7xl mx-auto px-2 sm:px-2.5 md:px-4 lg:px-8">
